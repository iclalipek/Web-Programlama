...
<body>
	...
	<div class="container-fluid py-4 px-3">
		...
		<div class="row">
			<div class="container text-center" id="details">
				<img src="image/admin.png" style="max-width: 180px;"
					class="img-fluid">
				<h3>
			...
			<div class="row px-3 py-3">
				<div class="col-md-4">
					<a href="display_category.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="image/category.png" style="max-width: 80px;"
									class="img-fluid">
				...
				<div class="col-md-4">
					<a href="display_products.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="image/products.png" style="max-width: 80px;"
									class="img-fluid">
				...
				<div class="col-md-4">
					<a href="display_orders.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="image/order.png" style="max-width: 80px;"
									class="img-fluid">
			...
			<div class="row px-3">
				<div class="col-md-4 offset-md-2">
					<a href="display_users.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="image/users.png" style="max-width: 80px;"
									class="img-fluid">
				...
				<div class="col-md-4">
					<a href="display_admin.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="image/add-admin.png" style="max-width: 80px;"
									class="img-fluid">
	...
	<div class="modal fade" id="add-category" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="AddOpServ" method="post"
						...
						<div class="row">
							<div class="col-md-6 mb-2">
								<label class="form-label"><b>Unit Price</b></label> <input
									type="number" name="price" onblur="validate()"
	...
	<script type="text/javascript">
		function validate() {
			var pri = document.addProductForm.price.value;
			if (pri < 0) {
				alert("Price need more 0 !");
