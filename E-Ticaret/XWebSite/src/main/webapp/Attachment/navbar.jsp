<%@page import="com.java.finalproject.model.Admin"%>
...
<%@page import="com.java.finalproject.model.Category"%>
...
CategoryDAO catDao = new CategoryDAO(ConnectionPro.getConnection());
...
<nav class="navbar navbar-expand-lg custom-color" data-bs-theme="dark">
	...
	<div class="container">
		<a class="navbar-brand" href="admin.jsp"><i
			class="fa-sharp fa-solid fa-house" style="color: #ffffff;"></i>&ensp;OnlineShop</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item pe-3"><a class="nav-link"
					aria-current="page" href="LogoutServ?user=user"><i
